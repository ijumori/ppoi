...
- 🟡 ペルソナを複数層で言語化（メイン+サブ2） — 要承認
- ✅ 競合調査・差別化ポイントが整理されている（§3）
- 🟡 収益モデルが決まっている（買い切り導入は要承認 / v1は広告のみ）
...
- ⬜ 新規機能（お気に入り/ストリーク/ウィジェット/ペイウォール）のUIモック
- 🟡 「創作明示」の文言・配置デザイン（FR-09）
...
- ⬜ 新規機能の回帰テスト観点追加（`agent-qa.mdc` 更新）
...
## 次アクション（優先順）
1. Phase 01 の収益モデル・ペルソナ・MVP を承認 → 確定欄更新。
2. v1.1 スコープ（W1〜W3）を Phase 04 UI 設計へ。
